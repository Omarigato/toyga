        ...
        <Card>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button type="submit" className="w-full" size="lg" isLoading={isLoading}>{t("auth.login")}</Button>
            </form>
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm"><span className="bg-white px-2 text-stone-400 dark:bg-stone-950">{t("auth.orContinue")}</span></div>
            </div>
            ...
            <p className="mt-6 text-center text-sm text-stone-500">
              {t("auth.noAccount")} <Link href="/register" className="font-medium text-amber-600 hover:underline">{t("auth.register")}</Link>
            </p>
          </CardContent>
        </Card>
      </motion.div>
